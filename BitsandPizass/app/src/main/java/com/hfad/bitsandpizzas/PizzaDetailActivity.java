...
public class PizzaDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int descriptionOfPizza = Pizza.pizzas[pizzaId].getDescriptionOfPizza();
        TextView textView1 =(TextView) findViewById(R.id.description_of_pizza);
        textView1.setText(descriptionOfPizza);
